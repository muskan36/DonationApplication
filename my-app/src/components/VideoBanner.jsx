    ...
    <div className='container py-88 md:py-16'>
        <div className='grid grid-colds-1 items-center md:grid-cols-2 gap-4 md:gap-8'>
            ...
            <div className='space-y-4 text-center md:text-left text-white'>
                ...
                <p> Watch now to discover how the Environmental & Animal Protection Fund is making a difference—from wildlife rescue to reforestation projects—and see how you can be part of the change.</p>
    ...
    <div className='container py-88 md:py-16'>
        <div className='grid grid-colds-1 items-center md:grid-cols-2 gap-4 md:gap-8'>
            ...
            <div className='space-y-4 text-center md:text-left text-white'>
                ...
                <p> Watch now to discover how the Environmental & Animal Protection Fund is making a difference—from wildlife rescue to reforestation projects—and see how you can be part of the change.</p>
                <a 
                  href="https://www.youtube.com/embed/iFMMI5TF-Mc?si=uhNbYdL89jEwganX" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className='btn-primary !bg-white !text-black inline-block hover:!bg-yellow-100 hover:scale-105 transition-all duration-300'
                >
                    Get Started
                </a>
            </div>
