...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-gradient-to-l from-green-900 via-green-600 to-green-900 text-white fixed top-0 left-0 w-full z-50">
              ...
              <ul className="flex items-center gap-10">
                <li className="group relative cursor-pointer">
                  <Link to="/" className="flex items-center gap-[2px] h-[72px]">
                    Home <span><FaCaretDown className="group-hover:rotate-180 transition-all duration-200"/></span>
                  </Link>
                  {/* Dropdown section*/} 
                  <div className="absolute -left-9 z-[99999] hidden w-[150px] bg-white shadow-md p-2 text-black rounded-md group-hover:block">
                    <ul className="space-y-3">
      ...
      {/* Mobile Side Menu Components*/}
      <ResponsiveMenu showMenu={showMenu} setShowMenu={setShowMenu} theme={theme} />
    </>
  );
};
